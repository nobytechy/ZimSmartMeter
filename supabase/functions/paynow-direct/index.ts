// ZimSmartMeter · direct PayNow Edge Function — REFERENCE IMPLEMENTATION
//
// ⚠ NOT DEPLOYED. PayNow's edge resets TCP connections from Supabase's
// egress IP ranges ("Connection reset by peer"), verified in production
// on 2026-08-23 — the same requests succeed from Render and residential
// networks. This file remains as the byte-accurate protocol reference
// (ordered-field SHA-512, inbound verification) and deploys unchanged
// from any PayNow-friendly egress. The LIVE `paynow` function routes
// through ManishaPay with provider="paynow" instead.
